---
title: "物理学におけるベクトルの基本操作と現象の処理"
---

物理学における位置、速度、加速度、力、電場、磁場などの多くの物理量は、大きさと向きを併せもつ**ベクトル**（vector）として記述される。ベクトルの基本操作と**線形性**（linearity）を理解することは、物理現象を簡潔かつ体系的に記述・解析するための基礎となる。
...
と表せる。以下では、この成分表示を用いてベクトルの基本操作を示し、それぞれの操作が物理現象において何を意味するかを整理する。
